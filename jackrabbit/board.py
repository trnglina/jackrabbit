...
class Board:
    __slots__ = "size", "ns", "maxpoint", "board", "neighbors", "visited"
    ...
    def __init__(self, size: int) -> None:
        ...
        self.board = np.full(self.maxpoint, BORDER, dtype=GoStone)
    ...
    def get_random_move_for(
        self, rng: np.random.Generator, color: GoStone
    ) -> Optional[int]:
